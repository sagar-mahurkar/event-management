...
export class ReviewService {
    ...
    // ---------------- LEAVE REVIEW ----------------
    async leaveReview(userId: number, eventId: number, rating: number, reviewText?: string, media?: string) {
        // Validate rating
        ...
        const booking = await bookingRepo.findOne({ where: { user: { id: userId }, event: { id: eventId } } });
